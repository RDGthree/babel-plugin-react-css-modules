...
const getTokens = (runner, cssSourceFilePath, filetypeOptions, includePaths) => {
  ...
  if (extension === '.scss') {
    fileContents = _nodeSass.default.renderSync({
...
var _default = (cssSourceFilePath, options) => {
  ...
  if (options.generateScopedName && typeof options.generateScopedName === 'function') {
    ...
    generateScopedName = (0, _genericNames.default)(options.generateScopedName || '[path]___[name]__[local]___[hash:base64:5]', {
